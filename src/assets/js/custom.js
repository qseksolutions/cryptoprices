...
setTimeout(function(){
	$('.sparkliness1').sparkline('html', { lineWidth:1,disableInteraction:true,spotColor:false,minSpotColor:false,maxSpotColor:false,width:125,lineColor:'#0b2545',height:22,fillColor:'#8da9c4'});
}, 3000);
